...
aws s3 cp infra/network.cfn.yml s3://chatanoo-deployment.eu-west-1/infra/network/$TRAVIS_TAG.cfn.yml
aws s3 cp infra/main.cfn.yml s3://chatanoo-deployment.eu-west-1/infra/main/$TRAVIS_TAG.cfn.yml
